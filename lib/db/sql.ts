/**
 * Plain SQL to bootstrap Rufus's Postgres schema on Neon. Mirrors
 * lib/db/schema.ts exactly. Idempotent (IF NOT EXISTS everywhere) so it
 * can also be re-run safely by /api/admin/db-setup with the SETUP_TOKEN.
 *
 * To run manually: paste into the Neon SQL editor, or pipe through psql.
 */
